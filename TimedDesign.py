...
def check_satisfiablityisfy_time(timed_design1, timed_design2):
...
def check_refine_ls(timed_design1, timed_design2):
    ...
    if (check_satisfiablityisfy_time(timed_design1, timed_design2) == False):
        return False
