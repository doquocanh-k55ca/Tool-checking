...
timed_design1 = timed_design("1<x<4","y >= x", (4,7))
timed_design2 = timed_design("x>10", "y > 5", (2,5))
timed_design3 = timed_design("x >= 12", "y > x", (4,6))
...
timed_design4 = timed_design("1<x<4","y >= x", (3,7))
